...
//
  ...
  /*
       ...
       // AppPreferences.getInstance().setAccesToken("44-600143353");
        //AppPreferences.getInstance().setUserID("44");
       ...
       wheelView.setWheelItemCount(ITEM_COUNT);
        ...
        if(!mode.equals("offline")) {
            if (AppPreferences.getInstance().getLoginStatus() == true) {
                ...
                Log.d("off status: " , String.valueOf(offlineStatus));
                if (!offlineStatus) {
        ...
        wheelView.setOnWheelItemClickListener( new WheelView.OnWheelItemClickListener() {
            ...
            public void onWheelItemClick(WheelView parent, int position, boolean isSelected) {
                ...
                switch (position) {
                    ...
                    case 4: {
                        Intent intent = new Intent( NavigationMenuActivity.this, WorkoutListActivity.class );
...
//                      i.putExtra("mode", "workout");
                  ...
                  /*  case 2: {
                        Intent intent = new Intent( NavigationMenuActivity.this, DatabaseCopyActivity.class );
                        intent.putExtra( "mode", "membership" );
                        startActivity( intent );
                        break;
                    }*/
